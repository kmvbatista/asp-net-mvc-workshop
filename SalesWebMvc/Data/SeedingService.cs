...
namespace SalesWebMvc.Data
{
    ...
    {
        //adicionando dependência do saleswebmvcContext
        private SalesWebMvcContext _context;

        //criando contrutor para indicar injeção de dependência
        public SeedingService(SalesWebMvcContext context)
        {
            this._context = context;
        }

        //quando um seedingSerivce for criado, automaticamente ele vai receber uma instancia do context
        ...
        public void Seed()
        {
            ...
            //o método addRange do linq te permite adicionar vários objetos de uma só vez
